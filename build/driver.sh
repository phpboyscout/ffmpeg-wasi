...
ENGINE_SRC="$DRIVER_SRC $SRC_DIR/specopts.c $SRC_DIR/sandbox.c $SRC_DIR/process.c $SRC_DIR/frames.c $SRC_DIR/meta.c $SRC_DIR/nativeio.c $SRC_DIR/progress.c $SRC_DIR/third_party/cJSON/cJSON.c"
