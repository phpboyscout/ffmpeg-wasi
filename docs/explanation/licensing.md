...
!!! danger "Self-compiled openh264 is outside Cisco's patent grant"
    ...
    modules Cisco itself builds and distributes**, and it does **not** travel with the source. ffmpeg-wasi
    ...
    - **Comply on demand.** If Via LA or any AVC rights-holder asks us to stop distributing the
      encoder, **we will pull it**, promptly and from both variants, rather than contest it.
...
## HEVC and AV1 encode: the *full* native profile only
...
- **AV1 via [SVT-AV1](https://gitlab.com/AOMediaCodec/SVT-AV1)**: **BSD-3-Clause-Clear + the Alliance
  ...
  and AV1 is **royalty-free by design** (AOMedia's patent commitment), so **no patent caveat applies**.
