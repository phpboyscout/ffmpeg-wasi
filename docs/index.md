...
<p class="hero-tagline">Current FFmpeg as a sandboxed WebAssembly module, plus a native driver for speed. For the server, not the browser.</p>
...
pipelines anywhere a WASI runtime does. It is designed for [wazero](https://wazero.io/), the pure-Go
