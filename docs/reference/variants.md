...
- **`full`**: intermediate **+ the heavy native-only encoders** (spec 0023): **AV1** via
  [SVT-AV1](https://gitlab.com/AOMediaCodec/SVT-AV1) (`libsvtav1`, both variants, BSD and royalty-free)
  and **HEVC/H.265** via [libx265](https://bitbucket.org/multicoreware/x265_git) (`libx265`, **gpl
  variant only**: GPL plus an active HEVC patent pool, see [licensing](../explanation/licensing.md)).
...
caveat; see [licensing](../explanation/licensing.md#h264-encode-and-the-avc-patent-pool).
